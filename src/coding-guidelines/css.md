...
ただし、Modifier には原則クラスセレクタを利用せず、[状態管理](http://localhost:5173/guidelines/coding-guidelines/css.html#%E7%8A%B6%E6%85%8B%E7%AE%A1%E7%90%86) のルールに基づいて、動的擬似クラスやUI要素状態擬似クラス、または属性セレクタを使用してください。
