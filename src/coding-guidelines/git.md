...
まだ、GitHub の Shibajuku チームに参加されてない方は、Shibajuku Home のプロフィール設定から参加してください。
:::
...
::: info プライベートリポジリトリの閲覧
事前に、Shibajuku の GitHub チームに所属しておく必要があります。所属していない方は、Shibajuku Home のプロフィール設定から参加してください。
:::
